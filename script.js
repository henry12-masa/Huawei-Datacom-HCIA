...
const quizInfo = {
  mtcna: {
    ...
    desc: "RouterOS基礎、IP設定、DHCP、NAT、Firewall、Wireless、トラブルシューティング"
  },
  mtcre: {
    title: "MikroTik MTCRE",
    desc: "静的ルーティング、OSPF、VPN、VLAN、経路制御、冗長化、RouterOS運用"
  },
  hciaDatacom: {
    title: "Huawei Datacom HCIA",
    desc: "Datacom基礎、VRP、Ethernet、IP、OSPF、ACL、NAT、WLANの入門"
  },
  hcipDatacom: {
    title: "Huawei Datacom HCIP",
    desc: "高度なDatacom設計、OSPF/IS-IS/BGP、MPLS、VXLAN、QoS、ネットワーク自動化"
  }
};
...
if (type === "all") {
  document.title = "MikroTik・Huawei Datacom資格クイズ";
  pageTitle.textContent = "MikroTik・Huawei Datacom資格クイズ";
  pageDesc.textContent = "4カテゴリ・各180問から50問ランダムで出題";
} else {
  const info = quizInfo[type] || quizInfo.mtcna;
